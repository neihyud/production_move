...
const STATUS_PRODUCT_ERROR_WARRANTY = 'error_warranty'
...
// 'lỗi_đã đưa về cơ sở sản xuất'
const STATUS_PRODUCT_ERROR_MANUFACTURE = 'error_manufacture'

// 'lỗi cần trả về nhà máy
const STATUS_PRODUCT_ERROR_FACTORY = 'error_factory'

// 'lỗi_cần triệu hồi'
const STATUS_PRODUCT_ERROR_RECALL = 'error_recall'

// 'hết hạn bảo hành'
const STATUS_PRODUCT_EXPIRE_WARRANTY = 'expire_warranty'

// 'trả về cơ sở sản xuất_do lâu không bán được'
